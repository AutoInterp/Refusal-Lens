...
- **Gemma figures:** [`data/tejas_experiments/figures/`](tejas_experiments/figures/).
- **Qwen figures:** [`data/qwen_experiments/figures/`](qwen_experiments/figures/) — generated by `data/qwen_experiments/scripts/make_figures.py`.
...
![Qwen layer separation](qwen_experiments/figures/layer_separation.png)
![Qwen sanity check projections](qwen_experiments/figures/sanity_check_projections.png)
...
![Qwen Arditi causal intervention](qwen_experiments/figures/causal_arditi_jailbreak.png)
...
![Qwen mechanism comparison](qwen_experiments/figures/mechanism_comparison.png)
...
![Qwen per-position cosine heatmap](qwen_experiments/figures/position_cosine_heatmap.png)
...
![Qwen Georg scaling collapse](qwen_experiments/figures/georg_scaling_collapse.png)
...
![Gemma vs Qwen summary](qwen_experiments/figures/summary_figure.png)
...
- Qwen figure generator: `data/qwen_experiments/scripts/make_figures.py` (regenerates everything in `data/qwen_experiments/figures/` from the JSON/PT results above)