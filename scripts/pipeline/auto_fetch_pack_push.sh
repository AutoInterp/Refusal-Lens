...
# Usage:
#   tmux new -s stage05
#   bash scripts/pipeline/auto_fetch_pack_push.sh [run_name] [mode]
#   # Detach: Ctrl-b d
...
cd "$REPO_ROOT"
RUN_DIR="data/results/pipeline_runs/$RUN_NAME"
...
laptop_fetch: python3 scripts/pipeline/fetch_graph_data.py --run $RUN_NAME --dataset-repo $DATASET_REPO
EOF
...
echo "  On your laptop:"
echo "    python3 scripts/pipeline/fetch_graph_data.py --run $RUN_NAME --dataset-repo $DATASET_REPO"
