...
mwhanna/qwen3-4b-transcoders/features/                                                                          
...
# Qwen3-4B transcoders ship `features/` at the repo root (not nested under
# a width/L0 subdir like Gemma Scope). Same dashboard binary format.
HF_REPO = "mwhanna/qwen3-4b-transcoders"
HF_FEATURES_PATH = "features"
...
def build_layer_histogram(comparison_labeled: dict, n_layers: int = 36) -> dict:
